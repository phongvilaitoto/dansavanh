...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const blogs = ref([]);
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(config.public.apiBase + "/getDBlogs?type=Offer", "$UzZ2CqnSdp")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" data-v-9945c71f${_scopeId}><div class="bg-cover" data-v-9945c71f${_scopeId}></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 22 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerT1" style="${ssrRenderStyle({ "font-size": "65px" })}" data-v-9945c71f${_scopeId3}>${ssrInterpolate(_ctx.$t("offerTitle"))}</h1>`);
                      } else {
                        return [
                          createVNode("h1", {
                            class: "headerT1",
                            style: { "font-size": "65px" }
                          }, toDisplayString(_ctx.$t("offerTitle")), 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(_component_a_col, { span: 22 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h5 class="headerT2" style="${ssrRenderStyle({ "margin-top": "-20px" })}" data-v-9945c71f${_scopeId3}>${ssrInterpolate(_ctx.$t("offerSubTitle"))}</h5>`);
                      } else {
                        return [
                          createVNode("h5", {
                            class: "headerT2",
                            style: { "margin-top": "-20px" }
                          }, toDisplayString(_ctx.$t("offerSubTitle")), 1)
                        ];
                      }
                    }),
                    _: 1
      ...
      _push(`<div class="max-width" data-v-9945c71f><div style="${ssrRenderStyle({ "margin": "2rem 0 2rem" })}" data-v-9945c71f><span style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-9945c71f>HOME</span><span style="${ssrRenderStyle({ "margin": "0 10px 0 10px", "color": "#A9A9A9" })}" data-v-9945c71f>/</span><span style="${ssrRenderStyle({ "color": "#A9A9A9" })}" data-v-9945c71f>OUR OFFERS</span></div><div data-v-9945c71f>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_a_row, {
                      onClick: ($event) => unref(router).push("/offer/" + i._id),
                        ...
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(_component_a_col, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="text-box" data-v-9945c71f${_scopeId4}><h2 data-v-9945c71f${_scopeId4}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2><p data-v-9945c71f${_scopeId4}>${ssrInterpolate(i.captions[unref(selectedIdx)])}</p><button class="btn btn-2 hover-slide-up" data-v-9945c71f${_scopeId4}><span data-v-9945c71f${_scopeId4}>${ssrInterpolate(_ctx.$t("discoverMore"))}</span></button></div>`);
                              } else {
                                return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9945c71f"]]);

export { index as default };
//# sourceMappingURL=index-Bb7WGV4d.mjs.map
