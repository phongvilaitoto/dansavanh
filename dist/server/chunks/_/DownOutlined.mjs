...
import { defineComponent, provide, computed, ref, createVNode, shallowRef, watch, Transition, getCurrentInstance, reactive, watchEffect, inject, nextTick, Text, render } from 'vue';
import { R as ResizeObserver, l as genCompactItemStyle, A as initMotion } from '../build/Title-C6q5tvoZ.mjs';
import { Z as warningOnce, P as PropTypes, i as classNames, W as objectType, h as useConfigInject, X as eventType, L as LoadingOutlined, _ as useToken, H as flattenChildren, m as useInjectDisabled, z as genComponentStyleHook, A as merge, $ as Keyframe, a0 as findDOMNode, O as genFocusStyle, I as Icon } from '../build/server.mjs';
import { c as createContext } from '../build/createContext-DErE1G0Y.mjs';
import { a as useCompactItemContext } from '../build/Compact-DWqqMN9n.mjs';
import { i as initDefaultProps } from '../build/index-CKfP-yp2.mjs';
...
const Button = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      if (href !== void 0) {
        return wrapSSR(createVNode("a", _objectSpread$1(_objectSpread$1({}, buttonProps2), {}, {
          "href": href,
          "target": target,
          "ref": buttonNodeRef
        }), [iconNode, kids]));
      }
      let buttonNode = createVNode("button", _objectSpread$1(_objectSpread$1({}, buttonProps2), {}, {
        "ref": buttonNodeRef,
        "type": htmlType
      }), [iconNode, kids]);
...
export { Button as B, DownOutlined as D, Overflow as O, slideDownIn as a, slideUpOut as b, slideDownOut as c, initMoveMotion as d, buttonProps as e, devWarning as f, initSlideMotion as i, slideUpIn as s, useState as u };
