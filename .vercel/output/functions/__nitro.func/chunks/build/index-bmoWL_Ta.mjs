    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" data-v-df470d2e${_scopeId}><div class="bg-cover" data-v-df470d2e${_scopeId}></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 22 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerT1" style="${ssrRenderStyle({ "font-size": "65px" })}" data-v-df470d2e${_scopeId3}>${ssrInterpolate(_ctx.$t("offerTitle"))}</h1>`);
                      } else {
                        return [
                          createVNode("h1", {
                            class: "headerT1",
                  ...
                  _push3(ssrRenderComponent(_component_a_col, { span: 22 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h5 class="headerT2" style="${ssrRenderStyle({ "margin-top": "-20px" })}" data-v-df470d2e${_scopeId3}>${ssrInterpolate(_ctx.$t("offerSubTitle"))}</h5>`);
                      } else {
                        return [
                          createVNode("h5", {
                            class: "headerT2",
      ...
      _push(`<div class="max-width" data-v-df470d2e><div style="${ssrRenderStyle({ "margin": "2rem 0 2rem" })}" data-v-df470d2e><span style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-df470d2e>HOME</span><span style="${ssrRenderStyle({ "margin": "0 10px 0 10px", "color": "#A9A9A9" })}" data-v-df470d2e>/</span><span style="${ssrRenderStyle({ "color": "#A9A9A9" })}" data-v-df470d2e>OUR OFFERS</span></div><div data-v-df470d2e>`);
                        ...
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(_component_a_col, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="text-box" data-v-df470d2e${_scopeId4}><h2 data-v-df470d2e${_scopeId4}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2><p data-v-df470d2e${_scopeId4}>${ssrInterpolate(i.captions[unref(selectedIdx)])}</p><button class="btn btn-2 hover-slide-up" data-v-df470d2e${_scopeId4}><span data-v-df470d2e${_scopeId4}>${ssrInterpolate(_ctx.$t("discoverMore"))}</span></button></div>`);
                              } else {
                                return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-df470d2e"]]);

export { index as default };
//# sourceMappingURL=index-bmoWL_Ta.mjs.map
