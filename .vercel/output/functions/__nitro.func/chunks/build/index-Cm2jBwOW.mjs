...
import { createVNode, defineComponent, computed, ref, inject, shallowRef, watchEffect, createTextVNode, Fragment, watch, provide, toRefs, reactive, toRaw, nextTick, toRef, isVNode, cloneVNode, isRef } from 'vue';
import { c as classNames, i as isValidElement, u as useConfigInject, H as useInjectDisabled, a6 as DefaultRenderEmpty, d as genComponentStyleHook, m as merge, l as someType, n as stringType, b as booleanType, k as functionType, x as flattenChildren, r as resetComponent, D as textEllipsis, F as resetIcon } from './useConfigInject-BiTbSa3p.mjs';
import { e as Trigger, B as BaseInput, c as cloneElement, s as supportsPassive, w as wrapperRaf, o as omit, u as useMergedState, p as useInjectFormItemContext, F as FormItemInputContext, q as getMergedStatus, v as getStatusClassNames, K as KeyCode, R as ResizeObserver, C as CheckOutlined, n as genCompactItemStyle } from './Title-YJvE5ZjV.mjs';
import { I as Icon, P as PropTypes, i as initDefaultProps } from './index-DJmKUcFc.mjs';
import { O as Overflow, u as useState, D as DownOutlined, s as slideUpIn, a as slideDownIn, b as slideUpOut, c as slideDownOut, i as initSlideMotion, e as initMoveMotion } from '../_/DownOutlined.mjs';
import { L as LoadingOutlined } from '../_/LoadingOutlined.mjs';
import { C as CloseOutlined } from '../_/CloseOutlined.mjs';
import { g as getTransitionName, d as getTransitionDirection, C as CloseCircleFilled } from '../_/CloseCircleFilled.mjs';
import { a as useCompactItemContext } from './Compact-mi0kmuGg.mjs';
...
const Selector = defineComponent({
  ...
  setup(props2, _ref) {
    ...
    return () => {
      ...
      const selectNode = mode === "multiple" || mode === "tags" ? createVNode(SelectSelector, _objectSpread$1(_objectSpread$1({}, props2), sharedProps), null) : createVNode(SingleSelector, _objectSpread$1(_objectSpread$1({}, props2), sharedProps), null);
      ...
      const selectorNode = createVNode(SelectTrigger, {
        ...
        default: () => {
          return customizeRawInputElement ? isValidElement(customizeRawInputElement) && cloneElement(customizeRawInputElement, {
            ref: selectorDomRef
          }, false, true) : createVNode(Selector, _objectSpread$1(_objectSpread$1({}, props2), {}, {
...
export { Select as S, SelectOption as a, selectProps as s };
//# sourceMappingURL=index-Cm2jBwOW.mjs.map
