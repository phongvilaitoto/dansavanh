...
import { createVNode, defineComponent, reactive, provide, watch, computed, onUnmounted, Teleport, ref, TransitionGroup, shallowRef, render, watchEffect } from 'vue';
import { A as AntdIcon, N as localeValues, B as warning, w as withInstall, c as classNames, O as useConfigContextInject, u as useConfigInject, Q as configProviderProps, T as defaultIconPrefixCls, U as createTheme, V as defaultSeedToken, W as useConfigContextProvider, X as useProvideGlobalForm, Y as useProviderSize, Z as useProviderDisabled, $ as LocaleReceiver, d as genComponentStyleHook, a0 as renderHelper, J as useToken, a1 as useStyleRegister, a2 as defaultConfig, a3 as renderEmpty, a4 as DesignTokenProvider, m as merge, H as resetIcon, r as resetComponent, a5 as wrapPromiseFn } from './index-C3iUBhQ2.mjs';
import _objectSpread$7 from '@babel/runtime/helpers/esm/objectSpread2';
import { b as getTransitionGroupProps, P as Portal, c as getMotion$1, K as Keyframe } from './Portal-B4Q6mTXn.mjs';
  ...
  const Wrapper = defineComponent({
    ...
    setup(_props, _ref4) {
      ...
      return () => {
        ...
        return createVNode(__nuxt_component_0, _objectSpread$7(_objectSpread$7({}, global), {}, {
...
const __nuxt_component_0 = ConfigProvider;

export { __nuxt_component_0 as _, api as a };
//# sourceMappingURL=index-BoKtI3Qq.mjs.map
