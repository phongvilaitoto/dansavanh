import { k as useMainStore, s as storeToRefs, f as useLocalePath } from './server.mjs';
...
import News from './index-BmIE_05R.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-width" }, _attrs))} data-v-ce27d668>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_col, { span: 24 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 class="text-uppercase" data-v-ce27d668${_scopeId2}>${ssrInterpolate(unref(main).home.titles[unref(selectedIdx)])}</h1>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="text-center" data-v-ce27d668${_scopeId2}>${ssrInterpolate(unref(main).home.descriptions[unref(selectedIdx)])}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-ce27d668${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: _imports_0,
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(main).home.cardZone, (i, key, idx) => {
              _push2(ssrRenderComponent(_component_a_col, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="card-swiper" data-v-ce27d668${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_nuxt_link, {
                      to: unref(localePath)(i.link)
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="casino-card" data-v-ce27d668${_scopeId3}><img class="casino-card-image"${ssrRenderAttr("src", i.img)} alt="" data-v-ce27d668${_scopeId3}><div class="casino-card-text-top" data-v-ce27d668${_scopeId3}><img${ssrRenderAttr("src", unref(icons)[idx])} alt="" data-v-ce27d668${_scopeId3}></div>`);
                          if (unref(isHover) !== idx) {
                            _push4(`<div class="casino-card-text" data-v-ce27d668${_scopeId3}><h2 data-v-ce27d668${_scopeId3}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2></div>`);
                          } else {
                            _push4(`<div class="casino-card-text" data-v-ce27d668${_scopeId3}><p data-v-ce27d668${_scopeId3}>${ssrInterpolate(i.descriptions[unref(selectedIdx)])}</p></div>`);
                          }
                          _push4(`</div><p data-v-ce27d668${_scopeId3}></p>`);
                        } else {
                          return [
...
const Welcome = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ce27d668"]]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-964e3908${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: _imports_0,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-info" data-v-964e3908${_scopeId2}><img${ssrRenderAttr("src", unref(main).home.hotelZone.img)} alt="" data-v-964e3908${_scopeId2}><h2 class="text-shadow text-bold" data-v-964e3908${_scopeId2}>${ssrInterpolate(unref(main).home.hotelZone.titles[unref(selectedIdx)])}</h2></div>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_space, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<button class="btn btn-2 hover-slide-up" data-v-964e3908${_scopeId2}><span data-v-964e3908${_scopeId2}>${ssrInterpolate(_ctx.$t("viewHotelsButton"))}</span></button>`);
                } else {
                  return [
                    createVNode("button", {
...
const HotelInfo = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-964e3908"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-55ba8612>`);
      ...
      _push(ssrRenderComponent(_component_a_layout_content, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-55ba8612${_scopeId}>`);
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { "data-aos": "slide-up" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="has-background" data-v-55ba8612${_scopeId}><div class="max-width" data-v-55ba8612${_scopeId}>`);
            _push2(ssrRenderComponent(HotelInfo, null, null, _parent2, _scopeId));
            _push2(`<br data-v-55ba8612${_scopeId}></div></section>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { "data-aos": "fade-up" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section data-v-55ba8612${_scopeId}><div class="content-container" data-v-55ba8612${_scopeId}><div class="max-width" data-v-55ba8612${_scopeId}>`);
            _push2(ssrRenderComponent(News, { isComp: true }, null, _parent2, _scopeId));
            _push2(`<div class="text-center" data-v-55ba8612${_scopeId}><button class="btn btn-2 hover-slide-up" data-v-55ba8612${_scopeId}><span data-v-55ba8612${_scopeId}>${ssrInterpolate(_ctx.$t("viewNews"))}</span></button><br data-v-55ba8612${_scopeId}><br data-v-55ba8612${_scopeId}></div></div></div></section>`);
          } else {
            return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-55ba8612"]]);

export { index as default };
//# sourceMappingURL=index-CLQD-4_A.mjs.map
