...
import { createVNode, defineComponent, computed, ref, inject, withDirectives, shallowRef, createTextVNode, Fragment, watch, watchEffect, provide, toRefs, reactive, toRaw, onUpdated, nextTick, toRef, isRef, onUnmounted, cloneVNode } from 'vue';
import { A as AntdIcon, P as PropTypes, c as classNames, v as initDefaultProps, i as isValidElement, u as useConfigInject, K as useInjectDisabled, af as DefaultRenderEmpty, d as genComponentStyleHook, m as merge, l as someType, n as stringType, b as booleanType, k as functionType, y as flattenChildren, r as resetComponent, F as textEllipsis, H as resetIcon } from './index-C3iUBhQ2.mjs';
import { T as Trigger, c as cloneElement, s as supportsPassive$1, w as wrapperRaf, o as omit, h as genCompactItemStyle } from './index-shETwSNC.mjs';
import { a as antInputDirective, u as useMergedState, c as useInjectFormItemContext, F as FormItemInputContext, d as getMergedStatus, e as getStatusClassNames, K as KeyCode, C as CheckOutlined, R as ResizeObserver } from './Title-C9T3KzZV.mjs';
...
import { u as useState } from './useState-DiUvnW6I.mjs';
import { L as LoadingOutlined } from '../_/LoadingOutlined.mjs';
import { C as CloseOutlined } from '../_/CloseOutlined.mjs';
import { C as CloseCircleFilled } from '../_/CloseCircleFilled.mjs';
import { a as getTransitionName, d as getTransitionDirection } from './Portal-B4Q6mTXn.mjs';
import { a as useCompactItemContext } from './Compact-B2HWyowC.mjs';
...
const SelectTrigger = defineComponent({
  ...
  setup(props2, _ref) {
    ...
    return () => {
      ...
      return createVNode(Trigger, _objectSpread$1(_objectSpread$1({}, props2), {}, {
...
const Selector = defineComponent({
  ...
  setup(props2, _ref) {
    ...
    return () => {
      ...
      const selectNode = mode === "multiple" || mode === "tags" ? createVNode(MultipleSelector, _objectSpread$1(_objectSpread$1({}, props2), sharedProps), null) : createVNode(SingleSelector$1, _objectSpread$1(_objectSpread$1({}, props2), sharedProps), null);
  ...
  setup(props2, _ref) {
    ...
    return () => {
      ...
      const selectorNode = createVNode(SelectTrigger$1, {
        ...
        default: () => {
          return customizeRawInputElement ? isValidElement(customizeRawInputElement) && cloneElement(customizeRawInputElement, {
            ref: selectorDomRef
          }, false, true) : createVNode(Selector$1, _objectSpread$1(_objectSpread$1({}, props2), {}, {
      ...
      if (customizeRawInputElement) {
        ...
        renderNode = createVNode("div", _objectSpread$1(_objectSpread$1({}, domProps), {}, {
...
const OptionList = defineComponent({
  ...
  setup(_, _ref) {
    ...
    function renderItem(index) {
      ...
      return item ? createVNode("div", _objectSpread$1(_objectSpread$1({
    ...
    return () => {
      ...
      return createVNode(Fragment, null, [createVNode("div", {
        ...
        default: (item, itemIndex) => {
          ...
          return createVNode("div", _objectSpread$1(_objectSpread$1({}, passedProps), {}, {
...
const Select$1 = defineComponent({
  ...
  setup(props2, _ref) {
    ...
    return () => {
      return createVNode(BaseSelect, _objectSpread$1(_objectSpread$1(_objectSpread$1({}, pickProps.value), attrs), {}, {
        "id": mergedId,
...
const Select = defineComponent({
  ...
  setup(props2, _ref) {
    ...
    return () => {
      ...
      return wrapSSR(createVNode(Select$1, _objectSpread$1(_objectSpread$1(_objectSpread$1({
        "ref": selectRef,
        "virtual": virtual,
        "dropdownMatchSelectWidth": dropdownMatchSelectWidth
      }, selectProps2), attrs), {}, {
...
Select.OptGroup;
const __nuxt_component_0 = Select;

export { SelectOption as S, __nuxt_component_0 as _, selectProps as s };
//# sourceMappingURL=index-Bpj8YU6d.mjs.map
