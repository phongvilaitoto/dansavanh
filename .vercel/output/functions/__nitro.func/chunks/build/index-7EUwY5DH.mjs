import { i as useMainStore, s as storeToRefs, f as useLocalePath, u as useHead } from './server.mjs';
...
import { _ as __nuxt_component_0 } from './nuxt-link-BN-11g_h.mjs';
import { _ as _imports_0 } from './decoration-1-KlcFkPXq.mjs';
import { u as useFlexGapSupport, _ as __nuxt_component_1, a as __nuxt_component_2 } from './index-B566YWDZ.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import _objectSpread from '@babel/runtime/helpers/esm/objectSpread2';
import _extends from '@babel/runtime/helpers/esm/extends';
import { P as PropTypes, L as LayoutContent } from './index-DJmKUcFc.mjs';
import { u as useConfigInject, c as classNames, f as filterEmpty, t as tuple, b as booleanType } from './useConfigInject-BiTbSa3p.mjs';
import { u as useStyle, C as Compact } from './Compact-mi0kmuGg.mjs';
import News from './index-DQ6cpG9H.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-width" }, _attrs))} data-v-bffddf6c>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_col, { span: 24 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 class="text-uppercase" data-v-bffddf6c${_scopeId2}>${ssrInterpolate(unref(main).home.titles[unref(selectedIdx)])}</h1>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="text-center" data-v-bffddf6c${_scopeId2}>${ssrInterpolate(unref(main).home.descriptions[unref(selectedIdx)])}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-bffddf6c${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: _imports_0,
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(main).home.cardZone, (i, key, idx) => {
              _push2(ssrRenderComponent(_component_a_col, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="card-swiper" data-v-bffddf6c${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_nuxt_link, {
                      to: unref(localePath)(i.link)
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="casino-card" data-v-bffddf6c${_scopeId3}><img class="casino-card-image"${ssrRenderAttr("src", i.img)} alt="" data-v-bffddf6c${_scopeId3}><div class="casino-card-text-top" data-v-bffddf6c${_scopeId3}><img${ssrRenderAttr("src", unref(icons)[idx])} alt="" data-v-bffddf6c${_scopeId3}></div>`);
                          if (unref(isHover) !== idx) {
                            _push4(`<div class="casino-card-text" data-v-bffddf6c${_scopeId3}><h2 data-v-bffddf6c${_scopeId3}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2></div>`);
                          } else {
                            _push4(`<div class="casino-card-text" data-v-bffddf6c${_scopeId3}><p data-v-bffddf6c${_scopeId3}>${ssrInterpolate(i.descriptions[unref(selectedIdx)])}</p></div>`);
                          }
                          _push4(`</div><p data-v-bffddf6c${_scopeId3}></p>`);
                        } else {
                          return [
...
const Welcome = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-bffddf6c"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(swipy)) {
        _push(`<div style="${ssrRenderStyle({ "position": "relative", "display": "flex", "justify-content": "center" })}"><p class="text-shadow" style="${ssrRenderStyle({ "position": "absolute", "color": "white", "font-size": "30px", "margin-top": "-80px", "z-index": "99999", "font-family": "'Playfair Display', serif" })}">${ssrInterpolate(unref(main).home.imgsTitles[unref(selectedIdx)][unref(swipy).realIndex])}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=index-7EUwY5DH.mjs.map
