import { createVNode, defineComponent, ref, computed, withDirectives, createTextVNode, toRef, useSSRContext, shallowRef, onUnmounted, withCtx, unref, isRef } from 'vue';
...
import { A as AntdIcon, P as PropTypes, c as classNames, h as hasProp, b as getComponent, i as isValidElement, s as splitAttrs, u as useConfigInject, d as useLocaleReceiver, e as enUS$1, g as genComponentStyleHook, m as merge, R as RightOutlined, j as LeftOutlined, r as resetComponent, _ as __nuxt_component_0$1, L as LayoutContent, k as genFocusOutline, l as genFocusStyle } from './index-j6mHhOx5.mjs';
import { s as selectProps, _ as __nuxt_component_0 } from './index-QDwLyBdt.mjs';
import { b as useResponsiveObserver, _ as __nuxt_component_1, a as __nuxt_component_2 } from './index-5qJONfuq.mjs';
import { w as withInstall, _ as _export_sfc, b as booleanType, c as arrayType, f as functionType, s as someType, d as stringType } from '../server.mjs';
import { a as antInputDirective, i as initInputToken, _ as __nuxt_component_4, g as genInputSmallStyle, b as genBasicInputStyle } from './Title-3mhyISKB.mjs';
import _objectSpread$2 from '@babel/runtime/helpers/esm/objectSpread2';
import { B as BaseMixin, f as firstNotUndefined, c as cloneElement } from './index-nRVkJx5M.mjs';
...
const MiniSelect = defineComponent({
  ...
  inheritAttrs: false,
  props: selectProps(),
  Option: __nuxt_component_0.Option,
  setup(props, _ref) {
    let {
      attrs,
      slots
    ...
    return () => {
      ...
      return createVNode(__nuxt_component_0, selelctProps, slots);
    };
  }
});
...
const Pagination = defineComponent({
  ...
  setup(props, _ref) {
    ...
    const [locale] = useLocaleReceiver("Pagination", enUS$1, toRef(props, "locale"));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" data-v-68d99e19${_scopeId}><div class="bg-cover" data-v-68d99e19${_scopeId}></div>`);
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { class: "content-container" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ width: "160px", margin: "20xp 0 0 " })}" data-v-68d99e19${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0,
            ...
            _push2(`<div style="${ssrRenderStyle({ padding: "24px", minHeight: "280px" })}" data-v-68d99e19${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-box" data-v-68d99e19${_scopeId3}><h2 data-v-68d99e19${_scopeId3}>STANDARD ROOM</h2><p data-v-68d99e19${_scopeId3}> With its lofty ceilings, white and rattan palette and antique tile floors, the Restaurant is a cool, elegant setting for breakfast, lunch and dinner. Serving authentic local and French-influenced cuisine, the Restaurant\u2019s Laotian specialties include fish or vegetables steamed in banana leaves with coriander and coconut milk. </p>`);
...
const invesmentProject = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-68d99e19"]]);

export { invesmentProject as default };
//# sourceMappingURL=invesment-project-pS2eSzG0.mjs.map
