...
import { A as AntdIcon, P as PropTypes, c as classNames, n as initDefaultProps, i as isValidElement, u as useConfigInject, y as useInjectDisabled, a1 as DefaultRenderEmpty, g as genComponentStyleHook, m as merge, f as flattenChildren, r as resetComponent, t as textEllipsis, w as resetIcon } from './index-j6mHhOx5.mjs';
import { s as someType, d as stringType, b as booleanType, f as functionType } from '../server.mjs';
import { T as Trigger, c as cloneElement, s as supportsPassive$1, w as wrapperRaf, o as omit } from './index-nRVkJx5M.mjs';
import { a as antInputDirective, u as useMergedState, d as useInjectFormItemContext, F as FormItemInputContext, e as getMergedStatus, f as getStatusClassNames, K as KeyCode, C as CloseCircleFilled, h as CheckOutlined, R as ResizeObserver } from './Title-3mhyISKB.mjs';
import { O as Overflow$1, D as DownOutlined, s as slideUpIn, a as slideDownIn, b as slideUpOut, c as slideDownOut, i as initSlideMotion, d as initMoveMotion } from '../../DownOutlined.mjs';
import { a as useState, b as useCompactItemContext, L as LoadingOutlined } from '../../LoadingOutlined.mjs';
import { a as getTransitionName, e as getTransitionDirection, b as genCompactItemStyle } from './compact-item-0fAWjO3D.mjs';
...
const Selector = defineComponent({
  ...
  setup(props2, _ref) {
    ...
    return () => {
      ...
      const selectNode = mode === "multiple" || mode === "tags" ? createVNode(MultipleSelector, _objectSpread$2(_objectSpread$2({}, props2), sharedProps), null) : createVNode(SingleSelector$1, _objectSpread$2(_objectSpread$2({}, props2), sharedProps), null);
      ...
      const selectorNode = createVNode(SelectTrigger$1, {
        ...
        default: () => {
          return customizeRawInputElement ? isValidElement(customizeRawInputElement) && cloneElement(customizeRawInputElement, {
            ref: selectorDomRef
          }, false, true) : createVNode(Selector$1, _objectSpread$2(_objectSpread$2({}, props2), {}, {
...
export { CloseOutlined$1 as C, SelectOption as S, __nuxt_component_0 as _, selectProps as s };
//# sourceMappingURL=index-QDwLyBdt.mjs.map
