<template>
  <HotelReuseComp :hotel="main.hotels[2]" />
  <!-- <a-layout>
      <div class="cover">
    ...
    <a-row justify="center">
      ...
      <a-col :xs="24" :sm="24" :md="12" :lg="12" style="text-align: center">
        <p style="font-size: 1rem; font-weight: 300; margin-top: 24px;">
          Situated in the city of Vientiane, 5 minute drive to Wattay International Airport and 10 minute to downtown centre and night market makes it a preferred location to many travellers. There is a banquet room that can accommodate 800 people and has witnessed umpteen wedding celebrations.
        </p>
      </a-col>
      <a-col
        :span="24"
...
.cover {
  background-image: url("/assets/image/hotels/vteroom.jpg");
...
.room-container {
  ...
  .room-cover {
    ...
    background-color: #5e5e5e;
    width: 200px;
    background-image: url("https://storage.googleapis.com/dsv-bucket/dvs-gallery/33.jpeg");
    background-position: center;
  }
  /* @media (min-width: 576px) {
      .room-info {  
