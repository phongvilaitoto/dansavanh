...
import { _ as __nuxt_component_0 } from './nuxt-link-D3GYj0JH.mjs';
import { g as useMainStore, s as storeToRefs } from './server.mjs';
import { _ as _imports_0 } from './decoration-1-KlcFkPXq.mjs';
import { u as useFlexGapSupport, _ as __nuxt_component_1, a as __nuxt_component_2$1 } from './index-BrQUnAzb.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import _objectSpread from '@babel/runtime/helpers/esm/objectSpread2';
import _extends from '@babel/runtime/helpers/esm/extends';
import { u as useConfigInject, c as classNames, f as filterEmpty, P as PropTypes, t as tuple, b as booleanType, L as LayoutContent } from './index-C3iUBhQ2.mjs';
import { u as useStyle, C as Compact } from './Compact-B2HWyowC.mjs';
import News from './index-BLmksmDd.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-width" }, _attrs))} data-v-b4c400db>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_col, { span: 24 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 class="text-uppercase" data-v-b4c400db${_scopeId2}>${ssrInterpolate(unref(main).home.titles[unref(selectedIdx)])}</h1>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="text-center" data-v-b4c400db${_scopeId2}>${ssrInterpolate(unref(main).home.descriptions[unref(selectedIdx)])}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-b4c400db${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: _imports_0,
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(main).home.cardZone, (i, key, idx) => {
              _push2(ssrRenderComponent(_component_a_col, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="card-swiper" data-v-b4c400db${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_nuxt_link, {
                      to: i.link
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="casino-card" data-v-b4c400db${_scopeId3}><img class="casino-card-image"${ssrRenderAttr("src", i.img)} alt="" data-v-b4c400db${_scopeId3}><div class="casino-card-text-top" data-v-b4c400db${_scopeId3}><img${ssrRenderAttr("src", unref(icons)[idx])} alt="" data-v-b4c400db${_scopeId3}></div>`);
                          if (unref(isHover) !== idx) {
                            _push4(`<div class="casino-card-text" data-v-b4c400db${_scopeId3}><h2 data-v-b4c400db${_scopeId3}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2></div>`);
                          } else {
                            _push4(`<div class="casino-card-text" data-v-b4c400db${_scopeId3}><p data-v-b4c400db${_scopeId3}>${ssrInterpolate(i.descriptions[unref(selectedIdx)])}</p></div>`);
                          }
                          _push4(`</div><p data-v-b4c400db${_scopeId3}></p>`);
                        } else {
                          return [
...
const Welcome = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b4c400db"]]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-3c247523${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: _imports_0,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card-info" data-v-3c247523${_scopeId2}><img${ssrRenderAttr("src", unref(main).home.hotelZone.img)} alt="" data-v-3c247523${_scopeId2}><h2 class="text-shadow text-bold" data-v-3c247523${_scopeId2}>${ssrInterpolate(unref(main).home.hotelZone.titles[unref(selectedIdx)])}</h2></div>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_space, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<button class="btn btn-2 hover-slide-up" data-v-3c247523${_scopeId2}><span data-v-3c247523${_scopeId2}>${ssrInterpolate(_ctx.$t("viewHotelsButton"))}</span></button>`);
                } else {
                  return [
                    createVNode("button", {
                      class: "btn btn-2 hover-slide-up",
                      onClick: ($event) => _ctx.$router.push("/hotels")
                    }, [
...
const HotelInfo = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3c247523"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-0d0a44e7>`);
      ...
      _push(ssrRenderComponent(_component_a_layout_content, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-0d0a44e7${_scopeId}>`);
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { "data-aos": "slide-up" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="has-background" data-v-0d0a44e7${_scopeId}><div class="max-width" data-v-0d0a44e7${_scopeId}>`);
            _push2(ssrRenderComponent(HotelInfo, null, null, _parent2, _scopeId));
            _push2(`<br data-v-0d0a44e7${_scopeId}></div></section>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { "data-aos": "fade-up" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section data-v-0d0a44e7${_scopeId}><div class="content-container" data-v-0d0a44e7${_scopeId}><div class="max-width" data-v-0d0a44e7${_scopeId}>`);
            _push2(ssrRenderComponent(News, { isComp: true }, null, _parent2, _scopeId));
            _push2(`<div class="text-center" data-v-0d0a44e7${_scopeId}><button class="btn btn-2 hover-slide-up" data-v-0d0a44e7${_scopeId}><span data-v-0d0a44e7${_scopeId}>${ssrInterpolate(_ctx.$t("viewNews"))}</span></button><br data-v-0d0a44e7${_scopeId}><br data-v-0d0a44e7${_scopeId}></div></div></div></section>`);
          } else {
            return [
                ...
                createVNode("div", { class: "content-container" }, [
                  createVNode("div", { class: "max-width" }, [
                    ...
                    createVNode("div", { class: "text-center" }, [
                      createVNode("button", {
                        class: "btn btn-2 hover-slide-up",
                        onClick: ($event) => _ctx.$router.push("/news")
                      }, [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0d0a44e7"]]);

export { index as default };
//# sourceMappingURL=index-BPpk8uYf.mjs.map
