import { _ as __nuxt_component_0 } from "./HeaderTitle-DPIm4vxC.js";
import { defineComponent, ref, withAsyncContext, withCtx, createVNode, toDisplayString, unref, openBlock, createBlock, Fragment, renderList, useSSRContext } from "vue";
...
import { y as useMainStore, z as storeToRefs, q as useLocalePath, A as useFetch, u as useHead, d as useRuntimeConfig } from "../server.mjs";
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HeaderTitle, {
        ...
        title: _ctx.$t("sportAndActivities"),
        caption: _ctx.$t("dActivities")
      }, null, _parent));
      _push(ssrRenderComponent(_component_a_layout_content, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="headerTitle text-uppercase" data-v-91978b23${_scopeId3}>${ssrInterpolate(_ctx.$t("tonsOfActivities"))}</h2>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="headerT2 text-black" data-v-91978b23${_scopeId3}>${ssrInterpolate(_ctx.$t("fromSport"))}</p>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-91978b23${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0,
            ...
            _push2(`<div class="blog max-width" data-v-91978b23${_scopeId}><!--[-->`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_a_col, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="text-box" data-v-91978b23${_scopeId3}><h1 data-v-91978b23${_scopeId3}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h1><p data-v-91978b23${_scopeId3}>${ssrInterpolate(i.captions[unref(selectedIdx)])}</p><button class="btn btn-2 hover-slide-up" data-v-91978b23${_scopeId3}><span data-v-91978b23${_scopeId3}>${ssrInterpolate(_ctx.$t("discoverMore"))}</span></button></div>`);
                        } else {
                          return [
                            createVNode("div", { class: "text-box" }, [
                              ...
                              createVNode("button", {
                                ...
                                onClick: ($event) => _ctx.$router.push(unref(localePath)("/experience") + "/" + i._id)
                              }, [
            ...
            _push2(`<!--]--></div><div class="line-header" data-v-91978b23${_scopeId}><span data-v-91978b23${_scopeId}>GALLERY</span><img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "40px", display: "block" })}" data-v-91978b23${_scopeId}></div>`);
            _push2(ssrRenderComponent(_component_a_row, { justify: "center" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-91978b23"]]);
export {
  index as default
};
//# sourceMappingURL=index-dJiY-RIo.js.map
