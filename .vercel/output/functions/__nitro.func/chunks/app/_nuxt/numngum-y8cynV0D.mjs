    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" data-v-1a9e66d7${_scopeId}><div class="bg-cover" data-v-1a9e66d7${_scopeId}></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 22 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerT1" style="${ssrRenderStyle({ "font-size": "45px" })}" data-v-1a9e66d7${_scopeId3}>${ssrInterpolate(_ctx.$t("DANSAVANH NAM NGUM RESORT AND CASINO"))}</h1>`);
                      } else {
                        return [
                          createVNode("h1", {
                            class: "headerT1",
                            style: { "font-size": "45px" }
                          }, toDisplayString(_ctx.$t("DANSAVANH NAM NGUM RESORT AND CASINO")), 1)
                        ];
                      }
                    }),
                    _: 1
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { class: "content-container" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 24 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<hr style="${ssrRenderStyle({ "border": "0", "margin-top": "24px", "border-top": "1px solid #eee" })}" data-v-1a9e66d7${_scopeId3}>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-1a9e66d7${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0,
            ...
            _push2(`<div class="max-width" data-v-1a9e66d7${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_row, { justify: "center" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 24 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerTitle" data-v-1a9e66d7${_scopeId3}> FACILITIES </h1>`);
                      } else {
                        return [
                ...
                if (_push3) {
                  ...
                  ssrRenderList(3, (i) => {
                    _push3(ssrRenderComponent(_component_a_col, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<img style="${ssrRenderStyle({ "width": "100%", "height": "100%", "object-fit": "cover" })}" src="https://storage.googleapis.com/dsv-bucket/golf-banner.jpeg" alt="" data-v-1a9e66d7${_scopeId3}><span data-v-1a9e66d7${_scopeId3}>FACILITIES ${ssrInterpolate(i)}</span>`);
                        } else {
                          return [
                            createVNode("img", {
            ...
            _push2(`</div><div class="line-header" data-v-1a9e66d7${_scopeId}><span data-v-1a9e66d7${_scopeId}>ROOM </span><img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-1a9e66d7${_scopeId}></div><div class="max-width" data-v-1a9e66d7${_scopeId}>`);
                              ...
                              if (_push5) {
                                ...
                                _push5(ssrRenderComponent(_component_a_col, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="text-box" data-v-1a9e66d7${_scopeId5}><h2 data-v-1a9e66d7${_scopeId5}>STANDARD ROOM ${ssrInterpolate(i)}</h2><p data-v-1a9e66d7${_scopeId5}> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Amet autem eius animi laudantium consectetur quisquam, consequuntur, cum illum itaque qui omnis quas laboriosam minus. Ratione, velit necessitatibus? Laboriosam, cum voluptate? <br data-v-1a9e66d7${_scopeId5}><br data-v-1a9e66d7${_scopeId5}><p class="details" data-v-1a9e66d7${_scopeId5}>`);
                                      _push6(ssrRenderComponent(_component_a_popover, { placement: "bottom" }, {
                                        content: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<p data-v-1a9e66d7${_scopeId6}>Content</p>`);
                                          } else {
                                            return [
            ...
            _push2(`</div><div class="line-header" data-v-1a9e66d7${_scopeId}><span data-v-1a9e66d7${_scopeId}>GALLERY</span><img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "40px", display: "block" })}" data-v-1a9e66d7${_scopeId}></div>`);
...
const numngum = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1a9e66d7"]]);

export { numngum as default };
//# sourceMappingURL=numngum-y8cynV0D.mjs.map
