...
import { L as LayoutContent } from './index-C3iUBhQ2.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout_content, mergeProps({ class: "content-container global-margin-top" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="line-header" data-v-6fa5db76${_scopeId}><h1 class="headerTitle" data-v-6fa5db76${_scopeId}>${ssrInterpolate(_ctx.$t("gallery"))}</h1><img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-6fa5db76${_scopeId}></div><div style="${ssrRenderStyle({ padding: "0 24px", minHeight: "280px" })}" data-v-6fa5db76${_scopeId}>`);
...
const gallery = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6fa5db76"]]);

export { gallery as default };
//# sourceMappingURL=gallery-DVVbsTwU.mjs.map
