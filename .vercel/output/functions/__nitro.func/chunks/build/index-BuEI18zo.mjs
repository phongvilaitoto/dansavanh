import { u as useRouter, f as useLocalePath, s as storeToRefs, k as useMainStore } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" data-v-174c04ac${_scopeId}><div class="bg-cover" data-v-174c04ac${_scopeId}></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 14 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h5 class="headerT2" data-v-174c04ac${_scopeId3}>${ssrInterpolate(_ctx.$t("stepInTheWorld"))}</h5>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerT1" data-v-174c04ac${_scopeId3}>${ssrInterpolate(_ctx.$t("ourHotels"))}</h1>`);
                      } else {
                        return [
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { class: "layout" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="blog" data-v-174c04ac${_scopeId}><!--[-->`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_a_col, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="text-box" data-v-174c04ac${_scopeId3}><span data-v-174c04ac${_scopeId3}>DANSAVANH &amp; HOTELS</span><h2 data-v-174c04ac${_scopeId3}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2><p data-v-174c04ac${_scopeId3}>${ssrInterpolate(i.descriptions[unref(selectedIdx)])}</p><button class="btn btn-2 hover-slide-up" data-v-174c04ac${_scopeId3}><span data-v-174c04ac${_scopeId3}>${ssrInterpolate(_ctx.$t("viewHotelButton"))}</span></button></div>`);
                        } else {
                          return [
                            createVNode("div", { class: "text-box" }, [
                              ...
                              createVNode("button", {
                                ...
                                onClick: ($event) => unref(router).push(unref(localePath)(i.link))
                              }, [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-174c04ac"]]);

export { index as default };
//# sourceMappingURL=index-BuEI18zo.mjs.map
