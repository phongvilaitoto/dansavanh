import { defineComponent, ref, withAsyncContext, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext, computed } from 'vue';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderSlot } from 'vue/server-renderer';
import { b as useLocalePath, ad as useRoute, d as useRouter, e as useMainStore, s as storeToRefs, f as useFetch, g as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_a_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId2}><i class="fa-regular fa-arrow-left"${_scopeId2}></i>\xA0 Back</span><span style="${ssrRenderStyle({ "margin": "0 10px 0 10px", "color": "#a9a9a9" })}"${_scopeId2}>/</span><span style="${ssrRenderStyle({ "color": "#a9a9a9" })}"${_scopeId2}>${ssrInterpolate(unref(blog).titles[unref(selectedIdx)])}</span>`);
                } else {
                  return [
                    createVNode("span", {
      ...
      _push(`<h1>${ssrInterpolate(unref(blog).titles[unref(selectedIdx)])}</h1><p>${ssrInterpolate(unref(blog).captions[unref(selectedIdx)])}</p><div>${(_a = unref(blog).descriptions[unref(selectedIdx)]) != null ? _a : ""}</div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=blogReuseComp-CQd6p83V.mjs.map
