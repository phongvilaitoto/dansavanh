...
import { createVNode, defineComponent, reactive, provide, watch, computed, Teleport, ref, TransitionGroup, shallowRef, render, watchEffect } from 'vue';
import { J as localeValues, q as warning, w as withInstall, c as classNames, K as useConfigContextInject, u as useConfigInject, L as configProviderProps, M as defaultIconPrefixCls, N as createTheme, O as seedToken, P as useConfigContextProvider, Q as useProvideGlobalForm, R as useProviderSize, S as useProviderDisabled, T as LocaleReceiver, d as genComponentStyleHook, U as renderHelper, G as useToken, V as useStyleRegister, W as defaultConfig, X as renderEmpty, Y as DesignTokenProvider, m as merge, F as resetIcon, r as resetComponent, Z as wrapPromiseFn } from './useConfigInject-BiTbSa3p.mjs';
import _objectSpread$7 from '@babel/runtime/helpers/esm/objectSpread2';
import { b as getTransitionGroupProps, P as Portal, C as CloseCircleFilled, c as getMotion$1, K as Keyframe } from '../_/CloseCircleFilled.mjs';
import { I as Icon } from './index-DJmKUcFc.mjs';
...
export { ConfigProvider as C, api as a };
//# sourceMappingURL=index-ktFDOHTj.mjs.map
