    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, { "data-aos": "fade-up" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" data-v-0cdbb72a${_scopeId}><div class="bg-cover" data-v-0cdbb72a${_scopeId}></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 22 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerT1" style="${ssrRenderStyle({ "font-size": "65px" })}" data-v-0cdbb72a${_scopeId3}>${ssrInterpolate(_ctx.$t("newsTitle"))}</h1>`);
                      } else {
                        return [
                          createVNode("h1", {
                            class: "headerT1",
      ...
      _push(`<div class="max-width" data-v-0cdbb72a><div data-v-0cdbb72a>`);
      if (!__props.isComp) {
        _push(`<div style="${ssrRenderStyle({ "margin": "2rem 0 2rem" })}" data-v-0cdbb72a><span style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-0cdbb72a>HOME</span><span style="${ssrRenderStyle({ "margin": "0 10px 0 10px", "color": "#A9A9A9" })}" data-v-0cdbb72a>/</span><span style="${ssrRenderStyle({ "color": "#A9A9A9" })}" data-v-0cdbb72a>NEWS</span></div>`);
      } else {
        _push(`<div style="${ssrRenderStyle({ "margin": "2rem 0 2rem" })}" data-v-0cdbb72a></div>`);
      }
                        ...
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(_component_a_col, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="text-box" data-v-0cdbb72a${_scopeId4}><h2 data-v-0cdbb72a${_scopeId4}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2><p data-v-0cdbb72a${_scopeId4}>${ssrInterpolate(i.captions[unref(selectedIdx)])}</p><button class="btn btn-2 hover-slide-up" data-v-0cdbb72a${_scopeId4}><span data-v-0cdbb72a${_scopeId4}>${ssrInterpolate(_ctx.$t("discoverMore"))}</span></button></div>`);
                              } else {
                                return [
...
const News = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0cdbb72a"]]);

export { News as default };
//# sourceMappingURL=index-BmIE_05R.mjs.map
