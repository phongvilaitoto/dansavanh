...
import { k as useMainStore, s as storeToRefs, m as useI18n, o as useSwitchLocalePath, f as useLocalePath, g as useRoute } from './server.mjs';
...
import { c as classNames, v as initDefaultProps, u as useConfigInject, ag as isNumeric, w as withInstall, P as PropTypes, d as genComponentStyleHook, D as objectType, x as getPropsSlot, a2 as defaultConfig, ah as derivative$2, j as arrayType, k as functionType, J as useToken$1, ai as LayoutFooter, aj as defaultPresetColors, ak as genColorMapToken, al as genFontMapToken, am as genControlHeight, m as merge } from './index-C3iUBhQ2.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-50f1b649>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("home"))}</p>`);
                } else {
                  return [
            ...
            _push2(`<br data-v-50f1b649${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("casino"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("hotels"))}</p>`);
                } else {
                  return [
            ...
            _push2(`<div style="${ssrRenderStyle({ "border-left": "1px solid white", "padding": "10px", "margin": "10px 0 10px" })}" data-v-50f1b649${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover small-text" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("hotelTab1"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover small-text" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("hotelTab2"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover small-text" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("hotelTab3"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("experience"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("events"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("offer"))}</p>`);
                } else {
                  return [
            ...
            _push2(`<br data-v-50f1b649${_scopeId}><p class="line-hover" data-v-50f1b649${_scopeId}>${ssrInterpolate(_ctx.$t("more"))}</p><div style="${ssrRenderStyle({ "border-left": "1px solid white", "padding": "10px", "margin": "10px 0 10px" })}" data-v-50f1b649${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover small-text" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("careerTitle"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover small-text" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("gallery"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover small-text" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("newsTitle"))}</p>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="line-hover" data-v-50f1b649${_scopeId2}>${ssrInterpolate(_ctx.$t("contact"))}</p>`);
                } else {
                  return [
            ...
            _push2(`<h3 class="text-white" style="${ssrRenderStyle({ "margin-top": "40px" })}" data-v-50f1b649${_scopeId}>ABOUT DANSAVANH</h3><p class="text-white" data-v-50f1b649${_scopeId}>Either you look for a luxurious experience or a remarkable on the go experience, Dansavanh Resort is the place to visit and spend the time at. We offer quality services.</p><p class="text-white" data-v-50f1b649${_scopeId}>VIP hotline : +856-20-58276666</p><p class="text-white" data-v-50f1b649${_scopeId}>Tour hotline: +856-20-52241111</p><p class="text-white" data-v-50f1b649${_scopeId}>Thai hotline: +66-92193-7777</p><p class="text-white" data-v-50f1b649${_scopeId}>info@dansavanh.com</p>`);
          } else {
            return [
...
const Drawer = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-50f1b649"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(_attrs)} data-v-73ec36fb><div class="navbar" data-v-73ec36fb><div class="navbar-start" data-v-73ec36fb><div class="navbar-brand" data-v-73ec36fb><img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-73ec36fb></div></div><div class="navbar-item is-desktop" data-v-73ec36fb>`);
      ...
      _push(`<div class="has-dropdrown" data-v-73ec36fb>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: unref(localePath)("/hotels"),
      ...
      if (unref(drowdownToggle)) {
        _push(`<ul class="dropdrown" style="${ssrRenderStyle({ "width": "310px !important" })}" data-v-73ec36fb><li data-v-73ec36fb>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          to: unref(localePath)("/hotels/numngum"),
      ...
      _push(ssrRenderComponent(_component_dividerProps, { class: "has-dropdrown" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(showMoreDropDown)) {
              _push2(`<ul class="dropdrown" style="${ssrRenderStyle({ "width": "180px !important" })}" data-v-73ec36fb${_scopeId}><li data-v-73ec36fb${_scopeId}>`);
              _push2(ssrRenderComponent(_component_nuxt_link, {
                class: "line-hover",
                to: unref(localePath)("/gallery")
              }, {
              ...
              _push2(`</li><li data-v-73ec36fb${_scopeId}>`);
              _push2(ssrRenderComponent(_component_nuxt_link, {
                to: unref(localePath)("/more/career"),
                class: "line-hover"
              }, {
      ...
      _push(`</div><div class="is-desktop" data-v-73ec36fb>`);
      _push(ssrRenderComponent(_sfc_main$4, { style: { "position": "absolute", "right": "0", "top": "15px" } }, null, _parent));
      _push(`</div><div class="is-mobile" data-v-73ec36fb><i style="${ssrRenderStyle({ "padding": "10px", "cursor": "pointer", "color": "white" })}" class="fa-solid fa-bars fa-xl" data-v-73ec36fb></i>`);
...
const NavBarVue = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-73ec36fb"]]);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} alt="Image" style="${ssrRenderStyle({ "max-width": "120px" })}" data-v-9524b6da${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0,
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<ul class="footer-nav" data-v-9524b6da${_scopeId3}><li data-v-9524b6da${_scopeId3}>`);
...
const FooterVue = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-9524b6da"]]);
...
//# sourceMappingURL=default-DvQSNIQo.mjs.map
