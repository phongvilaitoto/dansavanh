import { _ as __nuxt_component_0 } from "./HeaderTitle2-BL0rgiEi.js";
import { CarOutlined, PhoneOutlined, RedEnvelopeOutlined } from "@ant-design/icons-vue";
import { e as apiKey, f as useLocalePath, u as useHead } from "../server.mjs";
import { defineComponent, ref, unref, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext, reactive, createTextVNode, withModifiers, withDirectives, vModelText } from "vue";
import { ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrRenderAttr, ssrInterpolate } from "vue/server-renderer";
import { _ as _imports_0$2 } from "./decoration-1-KlcFkPXq.js";
import { GoogleMap, MarkerCluster, CustomMarker, InfoWindow } from "vue3-google-map";
import { a as api } from "./index-ktFDOHTj.js";
...
const _imports_1 = "" + __buildAssetsURL("bus2.CD1k8kJ3.png");
const _imports_0 = "" + __buildAssetsURL("map.Rg7XGIgM.jpeg");
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-box" data-v-1fcb6913${_scopeId3}><h3 style="${ssrRenderStyle({ "margin-bottom": "15px" })}" data-v-1fcb6913${_scopeId3}>${ssrInterpolate(_ctx.$t("dLocation"))}</h3><h4 style="${ssrRenderStyle({ "margin-bottom": "15px" })}" data-v-1fcb6913${_scopeId3}>${ssrInterpolate(_ctx.$t("gettingHere"))}</h4><p style="${ssrRenderStyle({ "text-align": "center" })}" data-v-1fcb6913${_scopeId3}> Wattay Airport – Look out for Dansavanh Meet &amp; Greet counter at the arrival hall. <br data-v-1fcb6913${_scopeId3}></p><p style="${ssrRenderStyle({ "text-align": "center" })}" data-v-1fcb6913${_scopeId3}> Lao-Thai immigration at Tanahleng - Daily departure at 7:30 am, 13:30 pm and 19:00 pm<br data-v-1fcb6913${_scopeId3}></p><p style="${ssrRenderStyle({ "text-align": "center" })}" data-v-1fcb6913${_scopeId3}> Dansavanh Vientiane Hotel – Daily departure starting from 6:30 am till 12:30 am at 2 hours interval<br data-v-1fcb6913${_scopeId3}></p><p style="${ssrRenderStyle({ "text-align": "center" })}" data-v-1fcb6913${_scopeId3}> A private limousine can be arranged via VIP hotline<br data-v-1fcb6913${_scopeId3}></p><p style="${ssrRenderStyle({ "text-align": "center" })}" data-v-1fcb6913${_scopeId3}> Please <a href="https://wa.me/8562052241111" target="_blank" data-v-1fcb6913${_scopeId3}><b data-v-1fcb6913${_scopeId3}>click here</b></a> to contact us on WhatsApp: <span style="${ssrRenderStyle({ "font-family": "Calibri, sans-serif", "font-size": "11pt" })}" data-v-1fcb6913${_scopeId3}><a href="https://wa.me/8562052241111" target="_blank" data-v-1fcb6913${_scopeId3}><b data-v-1fcb6913${_scopeId3}>+8562052241111</b></a></span><br data-v-1fcb6913${_scopeId3}></p><p style="${ssrRenderStyle({ "text-align": "center" })}" data-v-1fcb6913${_scopeId3}><span lang="EN" data-v-1fcb6913${_scopeId3}> You may also contact us on <b data-v-1fcb6913${_scopeId3}><a href="weixin://dl/chat?+85602058276666" target="_blank" data-v-1fcb6913${_scopeId3}>+8560205827</a>5555</b></span></p><p style="${ssrRenderStyle({ "text-align": "center" })}" data-v-1fcb6913${_scopeId3}><b data-v-1fcb6913${_scopeId3}>Email: Marketing@dansavanh.com</b></p><p style="${ssrRenderStyle({ "text-align": "center" })}" data-v-1fcb6913${_scopeId3}><a href="https://www.instagram.com/dansavanhnamngumresort/" target="_blank" data-v-1fcb6913${_scopeId3}><b data-v-1fcb6913${_scopeId3}>Follow us here on Instagram!</b></a></p></div>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-box" }, [
                            ...
                            createVNode("p", { style: { "text-align": "center" } }, [
                              ...
                              createTextVNode(" to contact us on WhatsApp: "),
                            ...
                            createVNode("p", { style: { "text-align": "center" } }, [
                              createVNode("span", { lang: "EN" }, [
                                createTextVNode(" You may also contact us on "),
                                createVNode("b", null, [
                                  createVNode("a", {
...
//# sourceMappingURL=index-0tU9RvL6.js.map
