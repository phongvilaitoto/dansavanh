...
import { createVNode, defineComponent, reactive, getCurrentInstance, watch, ref, Transition, computed, shallowRef, toRef, withDirectives, withModifiers, vShow, inject, provide, Fragment, watchEffect, toRefs, nextTick, toRaw, resolveDirective, cloneVNode, unref, createApp } from 'vue';
import { x as flattenChildren, c as classNames, b as booleanType, _ as canUseDom, $ as contains, I as findDOMNode, g as getComponent, h as hasProp, a0 as getEvents, f as filterEmpty, a1 as getSlot, u as useConfigInject, i as isValidElement, a2 as isFragment, w as withInstall, t as tuple, z as anyType, q as warning, H as useInjectDisabled, T as LocaleReceiver, a3 as tupleNum, a4 as getOptionProps, v as getPropsSlot, a5 as getStyle, d as genComponentStyleHook, C as eventType, B as objectType, m as merge, n as stringType, r as resetComponent, E as clearFix } from './useConfigInject-BiTbSa3p.mjs';
import _objectSpread$4 from '@babel/runtime/helpers/esm/objectSpread2';
import { c as getMotion, a as getTransitionProps, P as Portal$1, u as useProvidePortal, g as getTransitionName, C as CloseCircleFilled, K as Keyframe } from '../_/CloseCircleFilled.mjs';
import { I as Icon, P as PropTypes, i as initDefaultProps } from './index-DJmKUcFc.mjs';
import { c as createContext } from './createContext-DErE1G0Y.mjs';
...
const BaseInputInner = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(Tag, _objectSpread$4(_objectSpread$4({}, restProps), {}, {
        "ref": inputRef,
        "value": value
      }), null);
    };
...
const BaseInput = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(BaseInputInner, _objectSpread$4(_objectSpread$4(_objectSpread$4({}, restProps), attrs), {}, {
  ...
  setup(props, _ref) {
    ...
    const renderTextArea = () => {
      ...
      return createVNode(ResizeObserver, {
        ...
        default: () => [createVNode(BaseInput, _objectSpread$4(_objectSpread$4({}, textareaProps), {}, {
          "ref": textAreaRef,
          "tag": "textarea"
        }), null)]
      });
...
const TextArea = defineComponent({
  ...
  setup(props, _ref) {
    ...
    const renderTextArea = () => {
      ...
      return createVNode(ResizableTextArea, _objectSpread$4(_objectSpread$4({}, resizeProps), {}, {
    ...
    return () => {
      ...
      let textareaNode = createVNode(ClearableLabeledInput, _objectSpread$4(_objectSpread$4({}, inputProps2), {}, {
...
const TransButton = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode("div", _objectSpread$4(_objectSpread$4(_objectSpread$4({
        "role": "button",
        "tabindex": 0,
        "ref": domRef
      }, restProps), attrs), {}, {
...
const Typography = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return wrapSSR(createVNode(Component, _objectSpread$4(_objectSpread$4({}, restProps), {}, {
      ...
      return createVNode(LocaleReceiver, {
        ...
        "children": (locale) => {
          ...
          return createVNode(ResizeObserver, {
            ...
            default: () => [createVNode(Typography, _objectSpread$4({
              "ref": contentRef,
              "class": [{
...
export { baseProps as A, BaseInput as B, CheckOutlined as C, Portal as D, FormItemInputContext as F, KeyCode as K, PresetColors as P, ResizeObserver as R, Title as T, BaseMixin as a, genBasicInputStyle as b, cloneElement as c, Tooltip as d, Trigger as e, firstNotUndefined as f, genInputSmallStyle as g, getPlacements as h, initInputToken as i, initZoomMotion as j, abstractTooltipProps as k, getArrowStyle as l, getArrowOffset as m, genCompactItemStyle as n, omit as o, useInjectFormItemContext as p, getMergedStatus as q, roundedArrow as r, supportsPassive as s, tooltipDefaultProps as t, useMergedState as u, getStatusClassNames as v, wrapperRaf as w, initMotion as x, Base as y, Typography as z };
//# sourceMappingURL=Title-YJvE5ZjV.mjs.map
