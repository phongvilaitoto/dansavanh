    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" data-v-092ab0aa${_scopeId}><div class="bg-cover" data-v-092ab0aa${_scopeId}></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 14 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h5 class="headerT2" data-v-092ab0aa${_scopeId3}>${ssrInterpolate(_ctx.$t("careerSubTitle"))}</h5>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerT1" data-v-092ab0aa${_scopeId3}>${ssrInterpolate(_ctx.$t("careerTitle"))}</h1>`);
                      } else {
                        return [
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { class: "content-container max-width" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 24 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<hr style="${ssrRenderStyle({ "border": "0", "margin-top": "24px", "border-top": "1px solid #eee" })}" data-v-092ab0aa${_scopeId3}>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerTitle text-uppercase" style="${ssrRenderStyle({ "margin-top": "30px" })}" data-v-092ab0aa${_scopeId3}>${ssrInterpolate(_ctx.$t("dCareer"))}</h1>`);
                      } else {
                        return [
                          createVNode("h1", {
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="headerT2 text-black" data-v-092ab0aa${_scopeId3}>${ssrInterpolate(_ctx.$t("bestPlacesToWork"))}</p>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ width: "160px", margin: "20xp 0 0 " })}" data-v-092ab0aa${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0,
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h3 class="headerTitle text-uppercase" data-v-092ab0aa${_scopeId3}>${ssrInterpolate(_ctx.$t("availableJobs"))}</h3>`);
                      } else {
                        return [
            ...
            _push2(`<div style="${ssrRenderStyle({ padding: "24px", minHeight: "280px" })}" data-v-092ab0aa${_scopeId}><div class="career_box" data-v-092ab0aa${_scopeId}><!--[-->`);
            ssrRenderList(unref(blogs), (i) => {
              _push2(`<div class="text-box cursor" style="${ssrRenderStyle({ "margin": "30px 10px 30px 10px" })}" data-v-092ab0aa${_scopeId}><h3 class="text-uppercase" data-v-092ab0aa${_scopeId}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h3><p data-v-092ab0aa${_scopeId}>${ssrInterpolate(i.captions[unref(selectedIdx)])}</p></div>`);
            });
            _push2(`<!--]--></div></div>`);
          } else {
            return [
                ...
                createVNode("div", { class: "career_box" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(blogs), (i) => {
                    return openBlock(), createBlock("div", {
                      ...
                      onClick: ($event) => unref(router).push("/more/career/" + i._id),
                      key: i
                    }, [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-092ab0aa"]]);

export { index as default };
//# sourceMappingURL=index-CK9_2oRi.mjs.map
