import { _ as __nuxt_component_0$1 } from './nuxt-link-D3GYj0JH.mjs';
import { DesktopOutlined, WifiOutlined, CoffeeOutlined } from '@ant-design/icons-vue';
import { createVNode, defineComponent, ref, watch, computed, toRef, provide, getCurrentInstance, shallowRef, Transition, withDirectives, vShow, Fragment, inject, watchEffect, unref, Teleport, cloneVNode, toRaw, nextTick, withCtx, createTextVNode, openBlock, createBlock, renderList, useSSRContext } from 'vue';
...
import { A as AntdIcon, P as PropTypes, c as classNames, v as initDefaultProps, u as useConfigInject, R as RightOutlined, x as getPropsSlot, y as flattenChildren, z as isValid, S as SiderCollapsedKey, B as warning, C as skipFlattenKey, l as someType, D as objectType, b as booleanType, E as eventType, d as genComponentStyleHook, m as merge, i as isValidElement, r as resetComponent, q as genFocusStyle, _ as __nuxt_component_0, L as LayoutContent, F as textEllipsis, G as clearFix, p as genFocusOutline, H as resetIcon } from './index-C3iUBhQ2.mjs';
import _extends from '@babel/runtime/helpers/esm/extends';
import { T as Trigger, c as cloneElement, g as getPlacements, o as omit, a as Tooltip, w as wrapperRaf, r as roundedArrow, i as initZoomMotion, b as getArrowOffset } from './index-shETwSNC.mjs';
import { b as buttonProps, B as Button } from './index-DHXF1w76.mjs';
import { O as Overflow$1, D as DownOutlined, s as slideUpIn, a as slideDownIn, b as slideUpOut, c as slideDownOut, i as initSlideMotion, d as initMoveMotion } from '../_/DownOutlined.mjs';
import { d as devWarning } from './useState-DiUvnW6I.mjs';
import uniq from 'lodash-es/uniq.js';
import { K as KeyCode, _ as __nuxt_component_4 } from './Title-C9T3KzZV.mjs';
import { g as getTransitionProps } from './Portal-B4Q6mTXn.mjs';
...
const __nuxt_component_6 = defineComponent({
  ...
  setup(props, _ref) {
    ...
    const renderBreadcrumbNode = (breadcrumbItem, prefixCls2) => {
      ...
      if (overlay) {
        return createVNode(Dropdown$1, _objectSpread$1(_objectSpread$1({}, props.dropdownProps), {}, {
          "overlay": overlay,
          "placement": "bottom"
        }), {
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(Tooltip, _objectSpread$1(_objectSpread$1({}, tooltipProps), {}, {
        ...
        default: () => [createVNode(Overflow$1.Item, _objectSpread$1(_objectSpread$1(_objectSpread$1({
          "component": "li"
        }, attrs), {}, {
          "id": props.id,
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(MenuContextProvider, {
        ...
        default: () => [createVNode(Overflow$1.Item, _objectSpread$1(_objectSpread$1({
          "component": "li"
        }, attrs), {}, {
          "role": "none",
...
const Menu = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return wrapSSR(createVNode(Overflow$1, _objectSpread$1(_objectSpread$1({}, attrs), {}, {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_a_layout, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="cover" data-v-c3c230d0${_scopeId}>`);
  ...
  _push(ssrRenderComponent(_component_a_layout_content, { style: { "padding-bottom": "20px" } }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_a_col, { span: 24 }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<hr style="${ssrRenderStyle({ "border": "0", "margin-top": "24px", "border-top": "1px solid #eee" })}" data-v-c3c230d0${_scopeId3}>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_a_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-c3c230d0${_scopeId3}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: _imports_0,
        ...
        _push2(`<div style="${ssrRenderStyle({ background: "#fff", padding: "24px", minHeight: "280px" })}" data-v-c3c230d0${_scopeId}>`);
        _push2(ssrRenderComponent(_component_a_row, { justify: "center" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
            ...
            if (_push3) {
              ...
              ssrRenderList(4, (i) => {
                _push3(ssrRenderComponent(_component_a_col, {
                  ...
                  default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`<img${ssrRenderAttr("src", "")} alt="" data-v-c3c230d0${_scopeId3}><span data-v-c3c230d0${_scopeId3}>FACILITIES1</span>`);
                    } else {
                      return [
                        createVNode("img", {
                          src: "",
        ...
        _push2(`</div><div class="line-header" data-v-c3c230d0${_scopeId}><span data-v-c3c230d0${_scopeId}>ROOM </span><img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-c3c230d0${_scopeId}></div><div style="${ssrRenderStyle({ padding: "24px", minHeight: "280px" })}" data-v-c3c230d0${_scopeId}>`);
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(ssrRenderComponent(_component_a_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="text-box" data-v-c3c230d0${_scopeId3}><h2 data-v-c3c230d0${_scopeId3}><a href="#" data-v-c3c230d0${_scopeId3}>Standard Room</a></h2><p class="details" data-v-c3c230d0${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_a_popover, { placement: "bottom" }, {
                      content: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<p data-v-c3c230d0${_scopeId4}>Content</p>`);
                        } else {
                          return [
        ...
        _push2(`</div><div class="line-header" data-v-c3c230d0${_scopeId}><span data-v-c3c230d0${_scopeId}>GALLERY</span><img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "40px", display: "block" })}" data-v-c3c230d0${_scopeId}></div>`);
        _push2(ssrRenderComponent(_component_a_row, {
          justify: "center",
          style: { "display": "flex", "gap": "10px" }
        }, {
            ...
            if (_push3) {
              ...
              ssrRenderList(4, (i) => {
                _push3(ssrRenderComponent(_component_a_col, {
                  ...
                  default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`<img${ssrRenderAttr("src", "")} alt="" data-v-c3c230d0${_scopeId3}>`);
                    } else {
                      return [
                        createVNode("img", {
                          src: "",
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-c3c230d0"]]);

export { index as default };
//# sourceMappingURL=index-CrpXHjxd.mjs.map
