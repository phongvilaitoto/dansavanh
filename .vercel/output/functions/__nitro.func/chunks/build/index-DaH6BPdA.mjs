import { u as useRouter, g as useMainStore, s as storeToRefs, k as useFetch, b as useRuntimeConfig } from './server.mjs';
import { useSSRContext, defineComponent, ref, withAsyncContext, withCtx, createVNode, toDisplayString, unref, createTextVNode, openBlock, createBlock, Fragment, renderList } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const blogs = ref([]);
    const blogs2 = ref([]);
    const res = ([__temp, __restore] = withAsyncContext(() => useFetch(config.public.apiBase + "/getDBlogs?type=Events&eventType=Coming Events", "$nARolazKHS")), __temp = await __temp, __restore(), __temp);
    blogs.value = res.data.value.dBlogs;
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(config.public.apiBase + "/getDBlogs?type=Events&eventType=Past Events", "$YyeTK20Npk")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" data-v-bad4fabc${_scopeId}><div class="bg-cover" data-v-bad4fabc${_scopeId}></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerT1" data-v-bad4fabc${_scopeId3}>${ssrInterpolate(_ctx.$t("eventTitle"))}</h1>`);
                      } else {
                        return [
                          createVNode("h1", { class: "headerT1" }, toDisplayString(_ctx.$t("eventTitle")), 1)
                        ];
                      }
                    }),
                    _: 1
      ...
      _push(ssrRenderComponent(_component_a_layout_content, { class: "content-container" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 24 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<hr style="${ssrRenderStyle({ "border": "0", "margin-top": "24px", "border-top": "1px solid #eee" })}" data-v-bad4fabc${_scopeId3}>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="headerTitle" data-v-bad4fabc${_scopeId3}>${ssrInterpolate(_ctx.$t("eventComing"))}</h2>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "18px", "font-weight": "700", "font-family": "var(--font-family)" })}" data-v-bad4fabc${_scopeId3}>${ssrInterpolate(unref(blogs).length)}</span>`);
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-bad4fabc${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0,
            ...
            _push2(`<div style="${ssrRenderStyle({ padding: "24px", minHeight: "280px" })}" data-v-bad4fabc${_scopeId}><!--[-->`);
            ssrRenderList(unref(blogs), (i) => {
              _push2(ssrRenderComponent(_component_a_row, {
                onClick: ($event) => unref(router).push("/events/" + i._id),
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_a_col, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="text-box" data-v-bad4fabc${_scopeId3}><h2 data-v-bad4fabc${_scopeId3}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2><p data-v-bad4fabc${_scopeId3}>${ssrInterpolate(i.captions[unref(selectedIdx)])}</p><button class="btn btn-2 hover-slide-up" data-v-bad4fabc${_scopeId3}><span data-v-bad4fabc${_scopeId3}>${ssrInterpolate(_ctx.$t("discoverMore"))}</span></button></div>`);
                        } else {
                          return [
                            createVNode("div", { class: "text-box" }, [
                              ...
                              createVNode("button", {
                                ...
                                onClick: ($event) => _ctx.$router.push("/events/" + i._id)
                              }, [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerTitle" data-v-bad4fabc${_scopeId3}>${ssrInterpolate(_ctx.$t("eventPast"))}</h1>`);
                      } else {
                        return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bad4fabc"]]);

export { index as default };
//# sourceMappingURL=index-DaH6BPdA.mjs.map
