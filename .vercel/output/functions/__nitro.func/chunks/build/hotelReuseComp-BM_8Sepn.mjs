...
import { s as storeToRefs, g as useMainStore, u as useRouter } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_a_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cover" style="${ssrRenderStyle(`background-image: url('${__props.hotel.detail.img}')`)}" data-v-ac054676${_scopeId}><div class="bg-cover" data-v-ac054676${_scopeId}></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 22 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headerT1" style="${ssrRenderStyle({ "font-size": "45px" })}" data-v-ac054676${_scopeId3}>${ssrInterpolate(__props.hotel.detail.titles[unref(selectedIdx)])}</h1>`);
                      } else {
                        return [
                          createVNode("h1", {
                            class: "headerT1",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_a_col, { span: 24 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<hr style="${ssrRenderStyle({ "border": "0", "margin-top": "24px", "border-top": "1px solid #eee" })}" data-v-ac054676${_scopeId3}>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_a_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p style="${ssrRenderStyle({ "font-size": "1rem", "font-weight": "300", "margin-top": "24px" })}" data-v-ac054676${_scopeId3}>${ssrInterpolate(__props.hotel.detail.descriptions[unref(selectedIdx)])}</p>`);
                      } else {
                        return [
            ...
            if (__props.hotel.detail.usedList.includes("facilities")) {
              _push2(`<div class="max-width" data-v-ac054676${_scopeId}>`);
              _push2(ssrRenderComponent(_component_a_col, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block" })}" data-v-ac054676${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: _imports_0,
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_a_col, { span: 24 }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<h1 class="headerTitle" data-v-ac054676${_scopeId3}>${ssrInterpolate(_ctx.$t("facilities"))}</h1>`);
                        } else {
                          return [
                  ...
                  if (_push3) {
                    ...
                    ssrRenderList(__props.hotel.detail.facilities, (i) => {
                      _push3(ssrRenderComponent(_component_a_col, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "100%", "height": "100%", "object-fit": "cover" })}"${ssrRenderAttr("src", i.img)} alt="" data-v-ac054676${_scopeId3}><span class="text-shadow" style="${ssrRenderStyle({ "font-size": "25px" })}" data-v-ac054676${_scopeId3}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</span>`);
                          } else {
                            return [
                              createVNode("img", {
            ...
            if (__props.hotel.detail.usedList.includes("cards")) {
              _push2(`<div class="blog" data-v-ac054676${_scopeId}><!--[-->`);
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(ssrRenderComponent(_component_a_col, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="text-box" data-v-ac054676${_scopeId3}><span data-v-ac054676${_scopeId3}>DANSAVANH &amp; GOLF</span><h2 data-v-ac054676${_scopeId3}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2><p data-v-ac054676${_scopeId3}>${ssrInterpolate(i.descriptions[unref(selectedIdx)])}</p></div>`);
                          } else {
                            return [
            ...
            if (__props.hotel.detail.usedList.includes("rooms")) {
              _push2(`<div class="max-width" data-v-ac054676${_scopeId}><div class="line-header" data-v-ac054676${_scopeId}><span data-v-ac054676${_scopeId}>ROOM </span><img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "50px", display: "block", marginBottom: "50px" })}" data-v-ac054676${_scopeId}></div>`);
                                ...
                                if (_push5) {
                                  ...
                                  _push5(ssrRenderComponent(_component_a_col, {
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<div class="text-box" data-v-ac054676${_scopeId5}><h2 data-v-ac054676${_scopeId5}>${ssrInterpolate(i.titles[unref(selectedIdx)])}</h2><p data-v-ac054676${_scopeId5}>${ssrInterpolate(i.descriptions[unref(selectedIdx)])} <br data-v-ac054676${_scopeId5}><br data-v-ac054676${_scopeId5}><p class="details" data-v-ac054676${_scopeId5}>`);
                                        if (i.options.includes("TV")) {
                                          _push6(ssrRenderComponent(_component_a_popover, { placement: "bottom" }, {
                                            content: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                              if (_push7) {
                                                _push7(`<p data-v-ac054676${_scopeId6}>This room has Cable TV</p>`);
                                              } else {
                                                return [
                                        ...
                                        if (i.options.includes("WIFI")) {
                                          _push6(ssrRenderComponent(_component_a_popover, { placement: "bottom" }, {
                                            content: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                              if (_push7) {
                                                _push7(`<p data-v-ac054676${_scopeId6}>This room has WIFI</p>`);
                                              } else {
                                                return [
                                        ...
                                        if (i.options.includes("CAFE")) {
                                          _push6(ssrRenderComponent(_component_a_popover, { placement: "bottom" }, {
                                            content: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                              if (_push7) {
                                                _push7(`<p data-v-ac054676${_scopeId6}>This room has Cafe Bar</p>`);
                                              } else {
                                                return [
                                        ...
                                        _push6(`</p></p><button class="btn btn-2 hover-slide-up" data-v-ac054676${_scopeId5}><span data-v-ac054676${_scopeId5}>${ssrInterpolate(_ctx.$t("contact"))}</span></button></div>`);
                                      } else {
                                        return [
                                          createVNode("div", { class: "text-box" }, [
                                            createVNode("h2", null, toDisplayString(i.titles[unref(selectedIdx)]), 1),
            ...
            if (__props.hotel.detail.usedList.includes("galleries")) {
              _push2(`<div data-v-ac054676${_scopeId}><div class="line-header" data-v-ac054676${_scopeId}><span data-v-ac054676${_scopeId}>GALLERY</span><img${ssrRenderAttr("src", _imports_0)} alt="" style="${ssrRenderStyle({ height: "40px", display: "block" })}" data-v-ac054676${_scopeId}></div>`);
...
const HotelReuseComp = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ac054676"]]);

export { HotelReuseComp as H };
//# sourceMappingURL=hotelReuseComp-BM_8Sepn.mjs.map
