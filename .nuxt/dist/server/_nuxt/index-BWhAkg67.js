...
import { defineComponent, ref, computed, createVNode, Fragment, watch, inject, provide, toRaw, toRef, getCurrentInstance, shallowRef, Transition, withDirectives, vShow, nextTick, watchEffect, unref, Teleport, cloneVNode, withCtx, createTextVNode, openBlock, createBlock, renderList, useSSRContext } from "vue";
...
import { q as initZoomMotion, r as getArrowStyle, P as PresetColors, t as tooltipDefaultProps, v as Tooltip, o as omit, x as abstractTooltipProps, l as Trigger, e as cloneElement, y as roundedArrow, z as getArrowOffset, A as getPlacements, K as KeyCode, w as wrapperRaf, T as Title } from "./Title-CgfrIVWU.js";
import _objectSpread from "@babel/runtime/helpers/esm/objectSpread2";
import { i as initDefaultProps, P as PropTypes, S as SiderCollapsedKey, _ as __nuxt_component_0, L as LayoutContent } from "./index-DTnbOyTJ.js";
import { g as genComponentStyleHook, m as merge, r as resetComponent, b as warning, u as useConfigInject, c as classNames, w as withInstall, V as anyType, C as filterEmpty, a8 as skipFlattenKey, s as someType, O as objectType, G as booleanType, U as eventType, _ as genFocusStyle, P as isValidElement, N as getPropsSlot, B as flattenChildren, a9 as isValid, Z as genFocusOutline, a6 as textEllipsis, S as clearFix, i as resetIcon } from "./useConfigInject-BAI3R2rN.js";
import _extends from "@babel/runtime/helpers/esm/extends";
import { b as buttonProps, B as Button } from "./index-BABRc8xP.js";
import EllipsisOutlined from "@ant-design/icons-vue/es/icons/EllipsisOutlined.js";
import { s as slideUpIn, a as slideDownIn, b as slideUpOut, c as slideDownOut, i as initSlideMotion, e as initMoveMotion, d as devWarning, O as Overflow } from "./slide-Ihodq-aK.js";
...
import { c as getTransitionName, b as getTransitionProps } from "./Portal-BjKSqELH.js";
...
const Popover = defineComponent({
  ...
  setup(props, _ref) {
    ...
    warning(props.visible === void 0, "popover", `\`visible\` will be removed in next major version, please use \`open\` instead.`);
    expose({
      getPopupDomNode: () => {
        var _a, _b;
...
const __nuxt_component_6 = defineComponent({
  ...
  setup(props, _ref) {
    ...
    const renderBreadcrumbNode = (breadcrumbItem, prefixCls2) => {
      ...
      if (overlay) {
        return createVNode(Dropdown, _objectSpread(_objectSpread({}, props.dropdownProps), {}, {
          "overlay": overlay,
          "placement": "bottom"
        }), {
    ...
    return () => {
      ...
      if (props.href !== void 0) {
        link = createVNode("a", _objectSpread({
          "class": `${prefixCls.value}-link`,
          "onClick": handleClick
        }, restAttrs), [children]);
      } else {
        link = createVNode("span", _objectSpread({
          "class": `${prefixCls.value}-link`,
          "onClick": handleClick
        }, restAttrs), [children]);
      }
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(Tooltip, _objectSpread(_objectSpread({}, tooltipProps), {}, {
        ...
        default: () => [createVNode(Overflow.Item, _objectSpread(_objectSpread(_objectSpread({
          "component": "li"
        }, attrs), {}, {
          "id": props.id,
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(MenuContextProvider, {
        ...
        default: () => [createVNode(Overflow.Item, _objectSpread(_objectSpread({
          "component": "li"
        }, attrs), {}, {
          "role": "none",
  ...
  return (list || []).map((opt, index2) => {
    if (opt && typeof opt === "object") {
      ...
      if (children || type === "group") {
        ...
        return createVNode(SubMenu, _objectSpread(_objectSpread({
          "key": mergedKey
        }, restProps), {}, {
          "title": label,
          "originItemValue": opt
      ...
      store.set(mergedKey, menuInfo);
      return createVNode(MenuItem, _objectSpread(_objectSpread({
        "key": mergedKey
      }, restProps), {}, {
        "originItemValue": opt
      }), {
...
const Menu = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return wrapSSR(createVNode(Overflow, _objectSpread(_objectSpread({}, attrs), {}, {
  ...
  setup(props, _ref) {
    ...
    const genForRoutes = (_ref2) => {
      ...
      return routes.map((route) => {
        ...
        return createVNode(__nuxt_component_6, _objectSpread(_objectSpread({}, itemProps), {}, {
    ...
    return () => {
      ...
      return wrapSSR(createVNode("nav", _objectSpread(_objectSpread({}, attrs), {}, {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_DesktopOutlined = lib.DesktopOutlined;
  const _component_WifiOutlined = lib.WifiOutlined;
  const _component_CoffeeOutlined = lib.CoffeeOutlined;
  _push(`<!--[-->`);
...
//# sourceMappingURL=index-BWhAkg67.js.map
